...
try:
    ...
    another_paper_book = PaperBook("Мастер и Маргарита", "Михаил Булгаков", 448)
    another_audio_book = AudioBook("Мастер и Маргарита", "Михаил Булгаков", 12.0)

    print(another_paper_book)
    print(another_audio_book)

    # Попробуем установить некорректные значения
    another_paper_book.pages = -100  # Это вызовет ValueError
